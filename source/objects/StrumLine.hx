...
class StrumLine extends FlxTypedGroup<StrumNote>
{
	...
	public var character:GameCharacter;

	public var lanes(default, set):Int = 0;

	public function new(lanes:Int = 4, X:Float = 0, Y:Float = 0, char:String = "dad", ?isPlayer:Bool = false)
	{
		character = new GameCharacter(char, isPlayer);
		super();
